...
public class ConferenceSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ConferencePackage.REGISTRATION: {
				Registration registration = (Registration)theEObject;
				T result = caseRegistration(registration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConferencePackage.PERSONAL_DATA: {
				PersonalData personalData = (PersonalData)theEObject;
				T result = casePersonalData(personalData);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConferencePackage.NUTRITION_INFORMATION: {
				NutritionInformation nutritionInformation = (NutritionInformation)theEObject;
				T result = caseNutritionInformation(nutritionInformation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConferencePackage.FOOD_RESTRICTIONS: {
				FoodRestrictions foodRestrictions = (FoodRestrictions)theEObject;
				T result = caseFoodRestrictions(foodRestrictions);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConferencePackage.PAYMENT_DATA: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Nutrition Information</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Nutrition Information</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNutritionInformation(NutritionInformation object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Food Restrictions</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Food Restrictions</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFoodRestrictions(FoodRestrictions object) {
		return null;
	}
