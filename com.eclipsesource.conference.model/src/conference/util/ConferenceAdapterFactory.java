...
public class ConferenceAdapterFactory extends AdapterFactoryImpl {
	...
	protected ConferenceSwitch<Adapter> modelSwitch =
		new ConferenceSwitch<Adapter>() {
			...
			@Override
			public Adapter caseNutritionInformation(NutritionInformation object) {
				return createNutritionInformationAdapter();
			}
			@Override
			public Adapter caseFoodRestrictions(FoodRestrictions object) {
				return createFoodRestrictionsAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link conference.Registration <em>Registration</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link conference.PersonalData <em>Personal Data</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link conference.NutritionInformation <em>Nutrition Information</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link conference.FoodRestrictions <em>Food Restrictions</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link conference.PaymentData <em>Payment Data</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
