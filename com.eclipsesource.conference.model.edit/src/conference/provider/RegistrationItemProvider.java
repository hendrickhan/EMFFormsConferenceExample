...
/**
 * This is the item provider adapter for a {@link conference.Registration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RegistrationItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConferencePackage.Literals.REGISTRATION__PERSONAL_DATA);
			childrenFeatures.add(ConferencePackage.Literals.REGISTRATION__NUTRITION_INFORMATION);
			childrenFeatures.add(ConferencePackage.Literals.REGISTRATION__PAYMENT_DATA);
		}
	...
	public String getText(Object object) {
		String label = ((Registration)object).getId();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConferencePackage.Literals.REGISTRATION__PERSONAL_DATA,
				 ConferenceFactory.eINSTANCE.createPersonalData()));

		newChildDescriptors.add
			(createChildParameter
				(ConferencePackage.Literals.REGISTRATION__NUTRITION_INFORMATION,
				 ConferenceFactory.eINSTANCE.createNutritionInformation()));

		newChildDescriptors.add
			(createChildParameter
				(ConferencePackage.Literals.REGISTRATION__PAYMENT_DATA,
				 ConferenceFactory.eINSTANCE.createPaymentData()));
	}
