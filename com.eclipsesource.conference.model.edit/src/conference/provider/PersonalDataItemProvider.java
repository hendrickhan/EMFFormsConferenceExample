...
/**
 * This is the item provider adapter for a {@link conference.PersonalData} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PersonalDataItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PersonalData_firstName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PersonalData_firstName_feature", "_UI_PersonalData_type"),
				 ConferencePackage.Literals.PERSONAL_DATA__FIRST_NAME,
				 true,
				 false,
				 false,
	...
	protected void addLastNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PersonalData_lastName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PersonalData_lastName_feature", "_UI_PersonalData_type"),
				 ConferencePackage.Literals.PERSONAL_DATA__LAST_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addTitlePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PersonalData_title_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PersonalData_title_feature", "_UI_PersonalData_type"),
				 ConferencePackage.Literals.PERSONAL_DATA__TITLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addGenderPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PersonalData_gender_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PersonalData_gender_feature", "_UI_PersonalData_type"),
				 ConferencePackage.Literals.PERSONAL_DATA__GENDER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((PersonalData)object).getFirstName();
