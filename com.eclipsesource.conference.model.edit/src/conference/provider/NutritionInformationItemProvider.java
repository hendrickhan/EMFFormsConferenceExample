...
/**
 * This is the item provider adapter for a {@link conference.NutritionInformation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NutritionInformationItemProvider 
	 ...
	 * @generated
	 */
	public NutritionInformationItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This adds a property descriptor for the Diet feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDietPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NutritionInformation_diet_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NutritionInformation_diet_feature", "_UI_NutritionInformation_type"),
				 ConferencePackage.Literals.NUTRITION_INFORMATION__DIET,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConferencePackage.Literals.NUTRITION_INFORMATION__FOOD_RESTRICTIONS);
		}
	...
	/**
	 * This returns NutritionInformation.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/NutritionInformation"));
	}
	...
	public String getText(Object object) {
		Diet labelValue = ((NutritionInformation)object).getDiet();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_NutritionInformation_type") :
			getString("_UI_NutritionInformation_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConferencePackage.Literals.NUTRITION_INFORMATION__FOOD_RESTRICTIONS,
				 ConferenceFactory.eINSTANCE.createFoodRestrictions()));
	}
